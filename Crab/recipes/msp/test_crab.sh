...
HOME_DIR=$(echo ~)
AUDIO_DIR="/hadatasets/lucas.ueda/msp_podcast_2_ser/Audios/"

# Model directory from training
MODEL_DIR="${HOME_DIR}/github/Crab/experiments/msp/crab"
...
python ~/github/Crab/bin/test_crab.py \
  --df_path "${HOME_DIR}/github/MM-ser/bin/msp2_test3_labels.csv" \
...
if [ $INFERENCE_EXIT_CODE -eq 0 ]; then
    echo ""
    echo "Bimodal inference complet